...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        var m1 = other1.elements[0] * other2.elements[0];
        var m2 = other1.elements[1] * other2.elements[1];
        var m3 = other1.elements[2] * other2.elements[2];
        d = m1 + m2 + m3;
        return d;
    }
    ...
    normalize() {
        ...
        //console.log("norm: " + this.elements);
        return this;
    };
}
